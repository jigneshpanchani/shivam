...
@section('content')
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-5-6">
            <h4 class="heading_a uk-margin-bottom">Expense List</h4>
        </div>
        <div class="uk-width-medium-1-6 uk-text-right">
            <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light md-btn-icon" href="{{ route('expense.create') }}"><i class="uk-icon-plus-circle"></i> Add</a>
        </div>
    </div>
            ...
            <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                ...
                @foreach($expenses as $row)
                    <tr>
                        ...
                        <td>{{ $row['note'] }}</td>
                        <td>
                            <a href="{{ route('expense.edit', $row['id']) }}" class="uk-margin-left" title="Edit"><i class="uk-icon-edit uk-icon-small"></i></a>
