        ...
        <div>
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <h2 class="uk-margin-remove"><span class="countUpMe">0<noscript>depart</noscript></span></h2>
                </div>
            </div>
        </div>
        <div>
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <h2 class="uk-margin-remove"><span class="countUpMe">0<noscript>emp</noscript></span>
                    </h2>
                </div>
            </div>
        </div>
        <div>
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <h2 class="uk-margin-remove"><span class="countUpMe">0<noscript>Zone</noscript></span>
                </div>
            </div>
        </div>
    </div>
