                ...
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-6">
                        <div class="uk-input-group">
                            ...
                            <label>Salary (₹)</label>
                            <input type="text" name="salary" value="{{old('salary')}}" class="md-input masked_input label-fixed" id="masked_currency" data-inputmask="'alias': 'currency', 'groupSeparator': ',', 'autoGroup': true, 'digits': 2, 'digitsOptional': true, 'prefix': false, 'placeholder': '0'" data-inputmask-showmaskonhover="false" />
                        </div>
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
