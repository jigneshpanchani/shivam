                ...
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-4">
                        <div class="uk-input-group">
                            ...
                            <input type="text" name="balance" value="{{ $result['balance'] }}" class="md-input" readonly />
                        </div>
                    </div>
                    <div class="uk-width-medium-1-6">
                        <div class="uk-form-row parsley-row">
                            <label for="contact_no">Salary (₹)</label>
                            <input type="text" name="salary" value="{{ $totalSal }}" class="md-input" readonly />
                        </div>
                    </div>
                    <div class="uk-width-medium-1-6">
                        <div class="parsley-row">
                            <label for="name">Withdrawal (₹)</label>
                            <input type="text" name="name" value="{{ $totalWdl }}" class="md-input" readonly />
                        </div>
                    </div>
                    <div class="uk-width-medium-1-6">
                        <div class="parsley-row">
                            <label for="name">Total (₹)</label>
                            <input type="text" name="total" value="{{ $total }}" class="md-input" readonly />
                        </div>
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
