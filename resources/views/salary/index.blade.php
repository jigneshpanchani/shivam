...
@section('content')
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-5-6">
            <h4 class="heading_a uk-margin-bottom">Salary List</h4>
        </div>
        <div class="uk-width-medium-1-6 uk-text-right">
            <a class="md-btn md-btn-primary md-btn-small md-btn-wave-light md-btn-icon" href="{{ route('salary.create') }}"><i class="uk-icon-plus-circle"></i> Add</a>
        </div>
    </div>
            ...
            <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                ...
                @foreach($salaries as $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('salary.edit', $row['id']) }}" class="uk-margin-left" title="Edit"><i class="uk-icon-edit uk-icon-small"></i></a>
