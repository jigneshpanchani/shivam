                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-1-3">
                        <div class="uk-input-group">
                            ...
                            <input type="text" name="fuel_capacity" id="fuel_capacity" value="{{ (!empty($result['fuel_capacity'])) ? $result['fuel_capacity'] : old('fuel_capacity') }}" class="md-input" min="0" />
                        </div>
                        <br>
                        <div class="uk-input-group">
                            <span class="uk-input-group-addon">Seat Capacity</span>
                            <input type="text" name="seat" id="seat" value="{{ (!empty($result['seat'])) ? $result['seat'] : old('seat') }}" class="md-input" id="seat" min="0"/>
                        </div>
                    </div>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-1-2">
                        <div class="parsley-row">
                            ...
                            <textarea class="md-input" name="fitness" cols="10" rows="4">{{ (!empty($result['fitness'])) ? $result['fitness'] : old('fitness') }}</textarea>
                        </div>
                    </div>
                    <div class="uk-width-1-2">
                        <div class="parsley-row">
                            <label for="insurance">Insurance Details</label>
                            <textarea class="md-input" name="insurance" cols="10" rows="4">{{ (!empty($result['insurance'])) ? $result['insurance'] : old('insurance') }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="uk-grid">
