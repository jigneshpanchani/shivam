...
@section('content')
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-5-6">
            <h4 class="heading_a uk-margin-bottom">Add Partner Detail</h4>
        </div>
    ...
    <div class="md-card">
        <div class="md-card-content large-padding">
            <form name="bus_add" id="form_validation" class="uk-form-stacked" method="post" action="{{ route('partner.store') }}">
                {{ csrf_field() }}
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="uk-form-row parsley-row">
                            ...
                            <input name="contact_no" value="{{old('contact_no')}}" class="md-input masked_input" id="contact_no" type="text" data-inputmask="'mask': '9999 999 999'" data-inputmask-showmaskonhover="false" required/>
                        </div>
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-1-2">
                        <div class="parsley-row">
                            ...
                            <textarea class="md-input" name="address" cols="10" rows="3" required>{{old('address')}}</textarea>
                        </div>
                    </div>
                    <div class="uk-width-1-2">
                        <div class="parsley-row">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    @foreach($buses as $id=>$bus)
                                        <span class="icheck-inline">
                                            <input type="checkbox" name="bus[{{ $id }}]" id="bus_{{ $id }}" data-md-icheck />
